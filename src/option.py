...
# Data specifications
parser.add_argument('--dir_data', type=str, default='/data/super-resolution/',
...
parser.add_argument('--resume', type=int, default=0,
                    help='resume from specific checkpoint. -1: from model_latest; 0: from pre_train; $other: model_$other')
...
parser.add_argument('--bn_quant', action='store_true',
                    help='quant batch norm layer')

parser.add_argument('--three_layers', action='store_true',
                    help='fp model with only three layers')
parser.add_argument('--srresnet_lite_layers', type=int, default=16,
                    help='lite version for srresnet, how many layers in the body')
parser.add_argument('--calc_flops', action='store_true',
                    help='calculate model flops')

### Quantization option begin
quantization_enable = False
try:
    from third_party.quantization.main import get_parser
    ...
    parser.add_argument('--lr_policy', default='custom_step', type=str)
    parser.add_argument('--eta_min', default=0, type=float)
    quantization_enable = True
except (ImportError, RuntimeError, FileNotFoundError) as e:
    print('Import third_party code Failed in option.py', e)
### Quantization option end
...
if not os.path.isdir(args.dir_data) and os.path.isdir("../data"):
    args.dir_data = os.path.join(os.getcwd(), "../data")
